...
/**
 * print_x - mimics the behavior of the %x specifier in the printf
 * @args: Handles arguments containing va_list and buffer pointer
 *
 * Return: The number of characters printed excluding the null byte
 */
...
/**
 * print_X - mimics the behaviour of the %X specifier in printf
 * @args: Handles argumets containing va-list and buffer pointer
 *
 * Return: the number of characters printed excluding the null byte
 */
int print_X(HandlerArgs args)
